...
os.system("printf '\033]2;Hackers-Tool-Kit | Samrat | @hackelite01\a'")
...
;;;`    `   ;;`;;    ;;,.    ;;; ;;;;``;;;;   ;;`;;;;;;;;;;''''\033[1;36m
'[==/[[[[, ,[[ '[[,  [[[[, ,[[[[, [[[,/[[['  ,[[ '[[,   [[     \033[0m
  '''    $c$$$cc$$$c $$$$$$$$"$$$ $$$$$$c   c$$$cc$$$c  $$     \033[1;36m
 88b    dP 888   888,888 Y88" 888o888b "88bo,888   888, 88,    \033[0m
  "YMmMY"  YMM   ""` MMM  M'  "MMMMMMM   "W" YMM   ""`  MMM    
	\n""".decode('utf-8'))
...
def mainbanner2():
	print( """
          ...
          ;W                                 j.                                
         f#E         ..           ..       : EW,                   .. GEEEEEEEL
       .E#f         ;W,          ,W,     .Et E##j                 ;W, ,;;L#K;;.
      iWW;         j##,         t##,    ,W#t E###D.              j##,    t#E   
     L##Lffi      G###,        L###,   j###t E#jG#W;            G###,    t#E   
    tLLG##L     :E####,      .E#j##,  G#fE#t E#t t##f         :E####,    t#E   
      ,W#i     ;W#DG##,     ;WW; ##,:K#i E#t E#t  :K#E:      ;W#DG##,    t#E   
     j#E.     j###DW##,    j#E.  ##f#W,  E#t E#KDDDD###i    j###DW##,    t#E   
   .D#j      G##i,,G##,  .D#L    ###K:   E#t E#f,t#Wi,,,   G##i,,G##,    t#E   
  ,WK,     :K#K:   L##, :K#t     ##D.    E#t E#t  ;#W:   :K#K:   L##,    t#E   
  EG.     ;##D.    L##, ...      #G      ..  DWi   ,KK: ;##D.    L##,     fE   
  ,       ,,,      .,,           j                      ,,,      .,,       :   
...
go back: go back to main menu
	...
	""")
	print( "Type a number then your target   Ex: 5 www.github.com\n")
	j = False
	while not j:
		try:
...
def gmail():
  ...
  def main():
     print( '\033[93m=================================================')
     print( '\033[91m               Created by Mayank Rajput           ')
     print( '\033[93m=================================================')
     print( '\033[95m               ++++++++++++++++++++              ')
     print( '\n                                               ')
     print( '\033[92m  _,.                                            ')
...
def blackhydra():
	...
	print( R+" [*] My Ig : https://www.instagram.com/hackelite01")
	print( N+"(}xxx{):::::::::> AndroSec1337 Cyber Team & hackelite01")
	print()
	print( "              ===|[ Brute Force ]|===")
	print()
...
def anonon():
	...
	os.system(show)
	os.system('proxychains python Samrat.py --quickrun')
...
def wordlist():
	...
	print (Y+"wordlist saved to /root/Samrat/wordlists \033[0m")
	...
	while not found:
		try:
			...
			if x == "clear":
				os.system("clear")
			if x == "exit":
				print ("\nfollow @hackelite01 on instagram")
				print ("\nExiting...")
				break
...
--run           : run a command in Samrat from the terminal

--proxy         : run Samrat with proxychains

--quickrun      : run Samrat without starting menu
--------------------------------------------------------------
		""")
	if sys.argv[1] == "--run":
		if len(sys.argv) < 3:
	...
	if sys.argv[1] == "--proxy":
		os.system("service tor restart")
		os.system("proxychains python Samrat.py")
